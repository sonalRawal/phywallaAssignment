...
### Key points
- In this project we will work feature wise. That means we pick one object like user, product, cart, etc at a time. We work through it's feature. The steps would be:
...
### POST /login
- Allow an user to login with their phone.
